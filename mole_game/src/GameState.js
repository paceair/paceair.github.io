...
GameState.prototype.resetGame = function() {
    ...
    // Add score
    G.depth = 0;
    G.depthText = this.game.add.text(10, 10, 'Underground: 0', { font: '24px ' + G.mainFont, fill: '#3399ff', stroke: '#009933', strokeThickness: 5 });
...
GameState.prototype.showInstructions = function() {
    ...
    t = this.game.add.text(0, -100, 'Mole Dig', { font: '60px ' + G.mainFont, fill: '#ff00ff', stroke: '#AA88cc', strokeThickness: 10 });
    instructions.add(t);
    t.updateTransform();
    ...
    t = this.game.add.text(0, -100, 'Use arrow keys to control mole', { font: '40px ' + G.mainFont, fill: '#AAffff', align: 'center', stroke: '#448811', strokeThickness: 10 });
    instructions.add(t);
    t.updateTransform();
    t.x = this.game.width/2 - t.getBounds().width/2;
    t.alpha = 0;
    ...
    t = this.game.add.text(0, -100, 'Avoid Lava', { font: '40px ' + G.mainFont, fill: '#ff3300', align: 'center', stroke: '#ffff1a', strokeThickness: 10 });
    instructions.add(t);
    t.updateTransform();
    t.x = this.game.width/2 - t.getBounds().width/2;
    t.alpha = 0;
    ...
    t = this.game.add.text(0, -100, 'Avoid Monster', { font: '40px ' + G.mainFont, fill: '#ffEE3B', align: 'center', stroke: '#AF11cc', strokeThickness: 10 });
    instructions.add(t);
    t.updateTransform();
    t.x = this.game.width/2 - t.getBounds().width/2;
    t.alpha = 0;
    ...
    t = this.game.add.text(0, -100, 'Dig Deep', { font: '40px ' + G.mainFont, fill: '#55ffAA', align: 'center', stroke: '#449Fcc', strokeThickness: 10 });
    instructions.add(t);
    t.updateTransform();
    t.x = this.game.width/2 - t.getBounds().width/2;
    t.alpha = 0;
...
GameState.prototype.update = function() {
    // Update score
    G.depthText.setText('Underground: ' + G.depth);
