...
EndState.prototype.create = function() {
    ...
    t = this.game.add.text(0, -100, 'Game over', { font: '60px ' + G.mainFont, fill: '#ffff00', stroke: '#44AAcc', strokeThickness: 10 });
    t.updateTransform();
    ...
    t = this.game.add.text(0, -100, 'finish at depth:' + G.depth, { font: '40px ' + G.mainFont, fill: '#ffff00', stroke: '#44AAcc', strokeThickness: 10 });
    t.updateTransform();
    t.x = this.game.width/2 - t.getBounds().width/2;
    t.alpha = 0;
    ...
    t = this.game.add.text(0, this.game.height, 'Click to try again', { font: '40px ' + G.mainFont, fill: '#ffff00' });
    t.updateTransform();
    t.x = this.game.width/2 - t.getBounds().width/2;
    t.alpha = 0;
